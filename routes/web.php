...
Route::post('/search/uae',[UaeController::class,'search'])->name('uaesearch');
Route::post('/search/egy',[EgyController::class,'search'])->name('egysearch');
Route::post('/search/turk',[TurkController::class,'search'])->name('turksearch');
Route::post('/search/gor',[GorController::class,'search'])->name('gorsearch');
Route::post('/search/ran',[SearchController::class,'search'])->name('ransearch');
Route::post('/search/target',[TargetController::class,'search'])->name('targsearch');
Route::post('/search',[HomeController::class,'small_search'])->name('smsearch');
Route::post('/search/smuae',[UaeController::class,'small_search'])->name('uaesmsearch');
Route::post('/search/smegy',[EgyController::class,'small_search'])->name('egysmsearch');
Route::post('/search/smturk',[TurkController::class,'small_search'])->name('turksmsearch');
Route::post('/search/smgor',[GorController::class,'small_search'])->name('gorsmsearch');
Route::post('/search/smrn',[SearchController::class,'small_search'])->name('rnsmsearch');
Route::post('/search/smtarg',[TargetController::class,'small_search'])->name('targsmsearch');
