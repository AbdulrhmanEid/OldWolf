...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('fronted/css/gallery.css')); ?>" />
    ...
    <section class="mb-5">
      <div class="container-fluid">
        <h2 class="pt-5 text-center text-light mb-5 pb-3">
          <?php echo e(__('MyCustom.Photo gallery of our website')); ?>

          <img src="<?php echo e(asset('fronted/images/line-11.svg')); ?>" style="width: 150px" alt="" />
        </h2>
        <div class="row">
            <div class="col-sm-6">
                <img src="<?php echo e(asset('fronted/images/50cb1bd86055120b16892a46193d69f6c3f6a6279282c1a9ba94511f-2@2x.png')); ?>" class="img-fluid w-100 mb-4" style="height: 1000px;border-radius:30px;" alt="">
                <img src="<?php echo e(asset('fronted/images/50cb1bd86055120b16892a46193d69f6c3f6a6279282c1a9ba94511f-6@2x.png')); ?>" class="img-fluid w-100 mb-4" style="height: 488px;border-radius:30px" alt="">
                <img src="<?php echo e(asset('fronted/images/50cb1bd86055120b16892a46193d69f6c3f6a6279282c1a9ba94511f-7@2x.png')); ?>" class="img-fluid w-100 mb-4" style="height: 488px;border-radius:30px" alt="">
            </div>
            <div class="col-sm-6">
                <img src="<?php echo e(asset('fronted/images/50cb1bd86055120b16892a46193d69f6c3f6a6279282c1a9ba94511f-3@2x.png')); ?>" class="img-fluid w-100 mb-4" style="height: 488px;border-radius:30px" alt="">
                <img src="<?php echo e(asset('fronted/images/50cb1bd86055120b16892a46193d69f6c3f6a6279282c1a9ba94511f-4@2x.png')); ?>" class="img-fluid w-100 mb-4" style="height: 488px;border-radius:30px" alt="">
                <img src="<?php echo e(asset('fronted/images/50cb1bd86055120b16892a46193d69f6c3f6a6279282c1a9ba94511f-8@2x.png')); ?>" class="img-fluid w-100 mb-4" style="height: 488px;border-radius:30px" alt="">
                <img src="<?php echo e(asset('fronted/images/50cb1bd86055120b16892a46193d69f6c3f6a6279282c1a9ba94511f-9@2x.png')); ?>" class="img-fluid w-100 mb-4" style="height: 488px;border-radius:30px" alt="">
            </div>
...
<?php /**PATH F:\Laravel Basics\OldWolf\resources\views/fronted/gallery.blade.php ENDPATH**/ ?>