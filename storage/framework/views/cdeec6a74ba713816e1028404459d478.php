...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('fronted//css/contact.css')); ?>" />
    ...
    <section class="mb-5">
      <div class="container-fluid">
        <h2 class="pt-5 text-center text-light mb-5 pb-3">
            <?php echo e(__('MyCustom.Contact Us')); ?>
        ...
        <div class="row">
          <div class="col-md-6 contact-methods-1">
            <img
              src="<?php echo e(asset('fronted/images/contact2.svg')); ?>"
          ...
          <div class="col-md-6 text-md-left text-center">
            ...
            <?php endif; ?>
            <form class="contact-inputs text-md-left text-center" method="post" action="<?php echo e(route('userdata.store')); ?>">
                <?php echo csrf_field(); ?>
              <input
                type="text" name="name"
                class="w-100 mb-3"
      ...
      <div class="container-fluid">
        <div class="maps p-4">
          <div class="row">
            ...
            <div class="col-md-6 text-center">
              <a href="" class="map-link">El-Mahalla El-kobra</a>
...
<?php /**PATH F:\Laravel Basics\OldWolf\resources\views/fronted/contact.blade.php ENDPATH**/ ?>