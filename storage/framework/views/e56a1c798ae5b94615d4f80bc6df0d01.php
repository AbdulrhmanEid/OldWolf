...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('fronted/css/TUR.css')); ?>" />
...
<section class="search m-auto">
    <form action="<?php echo e(route('turksearch')); ?>" method="post">
        <?php echo csrf_field(); ?>
  ...
  <section class="small-search container-fluid mt-5">
    ...
    <div class="row hide-filter">
      ...
      <div class="col-8 p-0">
        <form action="<?php echo e(route('turksmsearch')); ?>" method="post">
            <?php echo csrf_field(); ?>
    ...
    <section class="mt-5 mb-5">
        <div class="container-fluid">
          <h2 class="pt-5 most-searched text-center text-light mb-5 pb-3">
            <?php echo e(__('MyCustom.Turkiye Random Result')); ?>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card" style="background: none;">
                    <a href="<?php echo e(route('target',$result->id)); ?>">
                        <img src="<?php echo e(Storage::url( $result->image )); ?> " style="height:250px;border-radius: 50px;" alt="" class="img-fluid w-100"></a>
                    <div class="card-info p-4">
                        <div class="d-flex justify-content-between">
                            <h5 class="gold"><?php echo e($result->type); ?></h5>
                            <h5 class="gold"><?php echo e($result->status); ?></h5>
                        </div>
                        <p class="text-light mt-3"><i class="fa-solid fa-location-dot gold mr-2"></i><?php echo e($result->location); ?></p>
                        <div class="row">
                            <div class="col-4 p-2">
                                <p class="text-light"><?php echo e($result->number_badrooms); ?> <img src="<?php echo e(asset('fronted/images/icon1.jpeg')); ?>" class="img-fluid w-25" alt=""></p>
                                <p class="text-light">BedRooms</p>
                            </div>
                            <div class="col-4 border-left p-2">
                                <p class="text-light"><?php echo e($result->number_bathrooms); ?> <img src="<?php echo e(asset('fronted/images/icon2.jpeg')); ?>" class="img-fluid w-25" alt=""></p>
                                <p class="text-light">Bathroom</p>
                            </div>
                            <div class="col-4 border-left p-2">
                                <p class="text-light"><?php echo e($result->area); ?> <img src="<?php echo e(asset('fronted/images/icon3.jpeg')); ?>" class="img-fluid w-25" alt=""></p>
...
<?php /**PATH F:\Laravel Basics\OldWolf\resources\views/fronted/turk-search.blade.php ENDPATH**/ ?>