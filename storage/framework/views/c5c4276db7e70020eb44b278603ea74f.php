...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('fronted/css/careers-2.css')); ?>" />
      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="x">
          <ul class="navbar-nav m-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item p-1">
              <a href="<?php echo e(route('careers')); ?>" class="nav-link active"><?php echo e(__('MyCustom.Careers')); ?></a>
            </li>
          </ul>
      ...
      <div class="container-fluid">
        ...
        <div class="row p-5">
          <div class="col-md-6 career-image-1 mb-4">
            <img src="<?php echo e(asset('fronted/images/old1.svg')); ?>" style="height:350px ;border-radius: 30px;" class="img-fluid w-100" alt="">
          </div>
          ...
          <div class="col-md-6 career-image-2">
            <img src="<?php echo e(asset('fronted/images/old1.svg')); ?>" style="height:350px ;border-radius: 35px;" class="img-fluid w-100" alt="">
          </div>
        </div>
      </div>
    </section>
...
<?php /**PATH F:\Laravel Basics\OldWolf\resources\views/fronted/careers-2.blade.php ENDPATH**/ ?>