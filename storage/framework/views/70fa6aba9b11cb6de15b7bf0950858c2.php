                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <form action="<?php echo e(route('admin.updatecareer',$career->id)); ?>" method="post">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('PUT'); ?>
                                                            <td><?php echo e($career->id); ?></td>
                                                            <td><input type="text" name="name" value="<?php echo e($career->name); ?>"></td>
                                                            <td><input type="text" name="location" value="<?php echo e($career->location); ?>"></td>
                                                            <td><textarea type="text" name="description" value=""><?php echo e($career->description); ?></textarea></td>
                                                            <td>
...
<?php /**PATH F:\Laravel Basics\OldWolf\resources\views/Admin/editcareer.blade.php ENDPATH**/ ?>