  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="row gallery-2">
          <div class="col-lg-6 col-6 p-1 mb-3"  style="height:500px ;border-radius: 30px;">
            ...
            <img
            src="<?php echo e(asset('fronted/img/photo.jpg')); ?>"
            class="img-fluid w-100 mb-3"
    ...
    <section class="contact">
      ...
      <div class="contact-info">
        ...
        <div class="btn pl-3 pr-3 p-2 ml-3 mt-3 text-dark" id="btn"><p><a href="<?php echo e(route('contact')); ?>"><b><?php echo e(__('MyCustom.Contact Us')); ?></b></a></p></div>
      </div>
    </section>
    <section
