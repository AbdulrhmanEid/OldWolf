...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('fronted/css/UAE.css')); ?>" />
...
<section class="search m-auto">
    <form action="<?php echo e(route('uaesearch')); ?>" method="post">
        <?php echo csrf_field(); ?>
  ...
  <section class="small-search container-fluid mt-5">
    ...
    <div class="row hide-filter">
      ...
      <div class="col-8 p-0">
        <form action="<?php echo e(route('uaesmsearch')); ?>" method="post">
            <?php echo csrf_field(); ?>
