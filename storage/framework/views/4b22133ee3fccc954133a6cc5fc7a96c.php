...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('fronted/css/GOR.css')); ?>" />
...
<section class="search m-auto">
    <form action="<?php echo e(route('gorsearch')); ?>" method="post">
        <?php echo csrf_field(); ?>
  ...
  <section class="small-search container-fluid mt-5">
    ...
    <div class="row hide-filter">
      ...
      <div class="col-8 p-0">
        <form action="<?php echo e(route('gorsmsearch')); ?>" method="post">
            <?php echo csrf_field(); ?>
    ...
    <section class="mt-5 mb-5">
        <div class="container-fluid">
          <h2 class="pt-5 most-searched text-center text-light mb-5 pb-3">
            <?php echo e(__('MyCustom.Georgia Random Result')); ?>
...
<?php /**PATH F:\Laravel Basics\OldWolf\resources\views/fronted/gor-search.blade.php ENDPATH**/ ?>