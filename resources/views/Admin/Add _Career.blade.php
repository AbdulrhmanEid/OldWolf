            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <body>
                                            ...
                                            @if (count($careers) > 0)
                                                @foreach ($careers as $career)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('admin.editecareer',$career->id) }}" class="edit"
                                                               ><i class="material-icons"
                                                                    data-toggle="tooltip"
                                                                    title="Edit">&#xE254;</i></a>

                                                                    <form action="{{ route('admin.destroyecareer', $career->id) }}" method="POST" type="button" class="btn btn-danger p-0" onsubmit="return confirm('Delete?')">
                                                                    @csrf
                                                                    @method('DELETE')
                        ...
                        <!-- Delete Modal HTML -->
                        <form action="{{ route('admin.destroyecareer',$career->id) }} " method="POST">
