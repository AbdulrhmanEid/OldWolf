                                            ...
                                            @if (count($data) > 0)
                                                @foreach ($data as $userdata)
                                                    <tr>
                                                        ...
                                                        <th>{{$userdata->phone_number  }}</th>
                                                        <th>{{$userdata->unit_code }}</th>
                                                        <th>{{$userdata->description  }}</th>

                                                        <td>
                                                            {{-- <a href="{{ route('admin.editecareer', $career->id) }}"
                                                                class="edit"><i class="material-icons"
                                                                    data-toggle="tooltip"
                                                                    title="Edit">&#xE254;</i></a> --}}

                                                            {{-- <form
                                                                action="{{ route('admin.destroyecareer', $career->id) }}"
