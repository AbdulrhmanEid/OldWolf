...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('fronted/css/target.css') }}" />
  ...
  <section class="search m-auto">
    <form action="{{ route('targsearch') }}" method="post">
        @csrf
  ...
  <section class="small-search container-fluid mt-5">
    ...
    <div class="row hide-filter">
      ...
      <div class="col-8 p-0">
        <form action="{{ route('targsmsearch') }}" method="post">
            @csrf
    ...
    <section class="mt-5 mb-5">
        <div class="container-fluid">
          <h2 class="pt-5 most-searched text-center text-light mb-5 pb-3">
            {{ __('MyCustom.Congratulations, you found your target') }}
            <img src="{{asset('fronted/images/line-11.svg')  }}" style="width: 150px" alt="" />
          </h2>

          <div class="row gallery-2">
            <div class="col-sm-6">
                <img src="{{ Storage::url($result->photo ) }}" class="img-fluid w-100 mb-4 hide" style="height: 950px;border-radius:35px;" alt="">
            </div>
            <div class="col-md-6">
                <img src="{{ Storage::url($result->photo2 ) }}" class="img-fluid w-100 mb-4" style="height: 462px;border-radius:35px;" alt="">
                <img src="{{ Storage::url($result->photo3 ) }}" class="img-fluid w-100 hide" style="height: 462px;border-radius:35px;" alt="">
                <img src="{{ Storage::url($result->photo4 ) }}" class="img-fluid w-100 d-none" style="height: 462px;border-radius:35px;" alt="">
                <img src="{{ Storage::url($result->photo5 ) }}" class="img-fluid w-100 d-none" style="height: 462px;border-radius:35px;" alt="">
                <img src="{{ Storage::url($result->photo6 ) }}" class="img-fluid w-100 d-none" style="height: 462px;border-radius:35px;" alt="">
            </div>
            <div class="arrows">
    ...
    <section>
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb-3">
                ...
                <p class="text-light mr-4" style="font-weight: bold">Unit Code : {{$result->unit_code }}</p>
            </div>
            <div class="attemps mt-4 mb-4">
                <h6 class="gold mb-5 pl-4 pt-2" style="font-size: 22px">{{$result->type}}</h6>
                <p class="text-light pl-3"><i class="fa-solid fa-location-dot mr-2 gold"> {{$result->location }} </i></p>
                <div class="row font p-4">
                    <div class="col p-1">
                        <p class="text-light" style="font-weight: bold" >{{$result->number_badrooms }}<img src="{{ asset('fronted/images/icon8.jpeg') }}" class="img-fluid w-25" alt=""></p>
                        <p class="text-light">BedRooms</p>
                    </div>
                    <div class="col p-1 border-left">
                        <p class="text-light" style="font-weight: bold" >{{$result->number_bathrooms }}<img src="{{ asset('fronted/images/icon9.jpeg') }}" class="img-fluid w-25" alt=""></p>
                        <p class="text-light">Bathroom</p>
                    </div>
                    <div class="col p-1 border-left">
                        <p class="text-light" style="font-weight: bold" >{{$result->kitchen  }}  <img src="{{ asset('fronted/images/icon7.jpeg') }}" class="img-fluid w-25" alt=""></p>
                        <p class="text-light">Kitchen</p>
                    </div>
                    <div class="col p-1 border-left">
                        <p class="text-light" style="font-weight: bold" >{{ $result->balcony }} <img src="{{ asset('fronted/images/icon6.jpeg') }}" class="img-fluid w-25" alt=""></p>
                        <p class="text-light">Balcony</p>
                    </div>
                    <div class="col p-1 border-left ">
                        <p class="text-light"  >{{$result->area }} <img src="{{ asset('fronted/images/icon10.jpeg') }}" class="img-fluid w-25" alt=""></p>
                        <p class="text-light">Area</p>
                    </div>
                </div>
            </div>
            <h4 class="gold ml-4">More Details</h4>
            <p class="text-light mt-4 ml-4 details-description">{{$result->description  }}</p>
            ...
            <div class="d-flex justify-content-around ml-auto mr-auto mt-5 mb-5 align-items-center p-2 text-center contact" >
                ...
                <p class="m-auto pl-2 pr-2">{{__('MyCustom.Contact Us')  }}</p>
    ...
    <script src="{{ asset('fronted/js/gallery-target.js') }}"></script>
