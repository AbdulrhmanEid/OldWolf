...
<html lang="en">
  ...
  <body>
    ...
    <section class="mt-5 mb-5">
        <div class="container-fluid">
          <h2 class="pt-5 most-searched text-center text-light mb-5 pb-3">
            Congratulations, you found your target
            <img src="../images/line-11.svg" style="width: 150px" alt="" />
          </h2>
          <div class="row gallery-2">
            <div class="col-sm-6">
                <img src="../images/50cb1bd86055120b16892a46193d69f6c3f6a6279282c1a9ba94511f-2@2x.png" class="img-fluid w-100 mb-4" style="height: 950px;border-radius:35px;" alt="">
            </div>
            <div class="col-sm-6">
                <img src="../images/50cb1bd86055120b16892a46193d69f6c3f6a6279282c1a9ba94511f-3@2x.png" class="img-fluid w-100 mb-4" style="height: 462px;border-radius:35px;" alt="">
                <img src="../images/50cb1bd86055120b16892a46193d69f6c3f6a6279282c1a9ba94511f-4@2x.png" class="img-fluid w-100" style="height: 462px;border-radius:35px;" alt="">
            </div>
            <div class="arrows">
    ...
    <section>
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb-3">
                ...
                <p class="text-dark mr-4">Code#apart123</p>
            </div>
            <div class="attemps mt-4 mb-4">
                <h6 class="gold mb-5 pl-4 pt-2">Apartments</h6>
                <p class="text-light pl-3"><i class="fa-solid fa-location-dot mr-2 gold"></i>Alex, Egypt</p>
                <div class="row font p-4">
                    <div class="col p-1">
                        <p class="text-light">3 <img src="../images/icon8.jpeg" class="img-fluid w-25" alt=""></p>
                        <p class="text-light">BedRooms</p>
                    </div>
                    <div class="col p-1 border-left">
                        <p class="text-light">2 <img src="../images/icon9.jpeg" class="img-fluid w-25" alt=""></p>
                        <p class="text-light">Bathroom</p>
                    </div>
                    <div class="col p-1 border-left">
                        <p class="text-light">1  <img src="../images/icon7.jpeg" class="img-fluid w-25" alt=""></p>
                        <p class="text-light">Kitchen</p>
                    </div>
                    <div class="col p-1 border-left">
                        <p class="text-light">2 <img src="../images/icon6.jpeg" class="img-fluid w-25" alt=""></p>
                        <p class="text-light">Balcony</p>
                    </div>
                    <div class="col p-1 border-left">
                        <p class="text-light">120m2 <img src="../images/icon10.jpeg" class="img-fluid w-25" alt=""></p>
                        <p class="text-light">Area</p>
                    </div>
                </div>
            </div>
            <h4 class="gold ml-4">More Details</h4>
            <p class="text-light mt-4 ml-4 details-description">Apartment in a prime location in Alex. The area of ​​the apartment is 120 meters. It contains 3 rooms, 2 bathrooms, and a balcony directly overlooking the Nile, and another balcony overlooking a garden.</p>
            <div class="d-flex justify-content-around ml-auto mr-auto mt-5 mb-5 align-items-center p-2 text-center contact" >
                ...
                <p class="m-auto pl-2 pr-2">Contact Us</p>
    ...
    <script src="../js/gallery-target.js"></script>
