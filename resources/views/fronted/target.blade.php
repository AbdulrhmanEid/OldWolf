    ...
    <section class="mt-5 mb-5">
        <div class="container-fluid">
          ...
          <div class="row gallery-2">
            <div class="col-sm-6">
                <img src="{{ Storage::url($result->photo ) }}" class="img-fluid w-100 mb-4" style="height: 950px;border-radius:35px;" alt="">
            </div>
            <div class="col-sm-6">
                <img src="{{ Storage::url($result->photo2 ) }}" class="img-fluid w-100 mb-4" style="height: 462px;border-radius:35px;" alt="">
                <img src="{{ Storage::url($result->photo3 ) }}" class="img-fluid w-100" style="height: 462px;border-radius:35px;" alt="">
                <img src="{{ Storage::url($result->photo4 ) }}" class="img-fluid w-100" style="height: 462px;border-radius:35px;" alt="">
                <img src="{{ Storage::url($result->photo5 ) }}" class="img-fluid w-100" style="height: 462px;border-radius:35px;" alt="">
                <img src="{{ Storage::url($result->photo6 ) }}" class="img-fluid w-100" style="height: 462px;border-radius:35px;" alt="">
            </div>
            <div class="arrows">
    ...
    <section>
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb-3">
                ...
                <p class="text-dark mr-4">Code : {{$result->unit_code }}</p>
            </div>
            <div class="attemps mt-4 mb-4">
                <h6 class="gold mb-5 pl-4 pt-2">{{$result->type }}</h6>
                <p class="text-light pl-3"><i class="fa-solid fa-location-dot mr-2 gold"> {{$result->location }} </i></p>
                <div class="row font p-4">
                    <div class="col p-1">
                        <p class="text-light">{{$result->number_badrooms }}<img src="{{ asset('fronted/images/icon8.jpeg') }}" class="img-fluid w-25" alt=""></p>
                        <p class="text-light">BedRooms</p>
                    </div>
                    <div class="col p-1 border-left">
                        <p class="text-light">{{$result->number_bathrooms }}<img src="{{ asset('fronted/images/icon9.jpeg') }}" class="img-fluid w-25" alt=""></p>
                        <p class="text-light">Bathroom</p>
                    </div>
                    <div class="col p-1 border-left">
                        <p class="text-light">{{$result->kitchen  }}  <img src="{{ asset('fronted/images/icon7.jpeg') }}" class="img-fluid w-25" alt=""></p>
                        <p class="text-light">Kitchen</p>
                    </div>
                    <div class="col p-1 border-left">
                        <p class="text-light">{{ $result->balcony }} <img src="{{ asset('fronted/images/icon6.jpeg') }}" class="img-fluid w-25" alt=""></p>
