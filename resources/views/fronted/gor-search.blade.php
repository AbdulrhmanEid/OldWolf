...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('fronted/css/GOR.css') }}" />
...
<section class="search m-auto">
    <form action="{{ route('gorsearch') }}" method="post">
        @csrf
  ...
  <section class="small-search container-fluid mt-5">
    ...
    <div class="row hide-filter">
      ...
      <div class="col-8 p-0">
        <form action="{{ route('gorsmsearch') }}" method="post">
            @csrf
    ...
    <section class="mt-5 mb-5">
        <div class="container-fluid">
          <h2 class="pt-5 most-searched text-center text-light mb-5 pb-3">
            {{ __('MyCustom.Georgia Random Result') }}
          </h2>
          <div class="row">
